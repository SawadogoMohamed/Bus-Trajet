                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('departements.update', $departement->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="col-12">
                                            <h3 class="form-title student-info">Formulaire de modification des departements
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" name="nom" value="{{ $departement->nom }}"
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <textarea class="form-control" style="height:100px" name="description" placeholder="activités">{{ $departement->description }}</textarea>
                                        </div>
                                    </div>

                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <strong style="font-size: 18px; color: black;">PDF actuel</strong>
                                            @if ($departement->pdf_path)
                                                <a href="{{ asset('storage/' . $departement->pdf_path) }}" target="_blank">
                                                    Voir le PDF actuel
                                                </a>
                                            @else
                                            ...
                                            @endif
                                            <br>
                                            <strong style="font-size: 18px; color: black;">Nouveau PDF</strong>
                                            <input type="file" name="nouveau_pdf" accept=".pdf">
                                        </div>
                                    </div>
