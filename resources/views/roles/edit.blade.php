                    ...
                    <div class="card comman-shadow"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        <h3 class="form-title student-info">Formulaire de modification des roles</h3>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    @foreach ($group as $value)
                                                        <td>
                                                            <div class="form-group">
                                                                <label>
                                                                    {{ Form::checkbox('permission[]', $value['id'], in_array($value['id'], $rolePermissions) ? true : false, ['class' => 'green-checkbox']) }}
                                                                    {{ $value['name'] }}
                                                                </label>
                                                            </div>
                                                        </td>
